...
namespace BlazorMonacoYaml.Helpers
{
    ...
    {
        public static async Task<string[]> SetDeltaDecorations(MonacoEditor monacoEditor, string[] deltaDecorationIds, BlazorMonaco.Range range, ModelDecorationOptions options)
        {
        ...
        public static async Task<ModelDeltaDecoration> BuildDeltaDecoration(MonacoEditor monacoEditor, BlazorMonaco.Range range, string message)
        {
